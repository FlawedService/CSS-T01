...
public class CustomerTransactionScripts {
	 ...
	 * SQL error.
	 */
	public void addCustomer (int vat, String denomination, int phoneNumber, DiscountType discountType, String address) 
		...
		try {
			CustomerRowDataGateway newCustomer = new CustomerRowDataGateway (vat, denomination, phoneNumber, discountType,address);
			newCustomer.insert();
